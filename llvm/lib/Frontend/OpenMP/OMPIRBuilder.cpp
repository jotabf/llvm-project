...
OpenMPIRBuilder::InsertPointTy OpenMPIRBuilder::applyDynamicWorkshareLoop(
  ...
  // da barreira implicita da diretiva) e mesmo ident_t do "init". Dois
  // argumentos, a assinatura upstream: quem decide se este loop esta sendo
  // ajustado e o proprio __kmp_end_autotuning, procurando o loc na tabela --
  // nao ha bit de modo para propagar aqui, e no caminho do OMPIRBuilder quem
  // liga o autotuning e KMP_AT_FORCE do lado do runtime.
